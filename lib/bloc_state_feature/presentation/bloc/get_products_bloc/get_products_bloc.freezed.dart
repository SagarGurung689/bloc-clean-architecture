...
$GetProductsEventCopyWith(GetProductsEvent _, $Res Function(GetProductsEvent) __);
}
...
class _FetchProducts implements GetProductsEvent {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<GetProductResponse> products)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<GetProductResponse> products)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<GetProductResponse> products)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Loaded implements GetProductsState {
  const _Loaded(final  List<GetProductResponse> products): _products = products;
  

 final  List<GetProductResponse> _products;
 List<GetProductResponse> get products {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $GetProductsStateCopyWith<$Res> {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $GetProductsStateCopyWith<$Res> {
