...
$GetProductModelCopyWith<GetProductModel> get copyWith => _$GetProductModelCopyWithImpl<GetProductModel>(this as GetProductModel, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetProductModel&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.price, price) || other.price == price)&&(identical(other.description, description) || other.description == description)&&(identical(other.category, category) || other.category == category)&&(identical(other.image, image) || other.image == image)&&(identical(other.rating, rating) || other.rating == rating));
}
...
@override
String toString() {
  return 'GetProductModel(id: $id, title: $title, price: $price, description: $description, category: $category, image: $image, rating: $rating)';
}
...
/// @nodoc
abstract mixin class $GetProductModelCopyWith<$Res>  {
  factory $GetProductModelCopyWith(GetProductModel value, $Res Function(GetProductModel) _then) = _$GetProductModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$GetProductModelCopyWithImpl<$Res>
    implements $GetProductModelCopyWith<$Res> {
  _$GetProductModelCopyWithImpl(this._self, this._then);

  final GetProductModel _self;
  final $Res Function(GetProductModel) _then;
...
/// Adds pattern-matching-related methods to [GetProductModel].
extension GetProductModelPatterns on GetProductModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GetProductModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetProductModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GetProductModel value)  $default,){
final _that = this;
switch (_that) {
case _GetProductModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GetProductModel value)?  $default,){
final _that = this;
switch (_that) {
case _GetProductModel() when $default != null:
return $default(_that);case _:
...
class _GetProductModel implements GetProductModel {
  const _GetProductModel({this.id, this.title, this.price, this.description, this.category, this.image, this.rating});
  factory _GetProductModel.fromJson(Map<String, dynamic> json) => _$GetProductModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$GetProductModelCopyWith<_GetProductModel> get copyWith => __$GetProductModelCopyWithImpl<_GetProductModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GetProductModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetProductModel&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.price, price) || other.price == price)&&(identical(other.description, description) || other.description == description)&&(identical(other.category, category) || other.category == category)&&(identical(other.image, image) || other.image == image)&&(identical(other.rating, rating) || other.rating == rating));
}
...
/// @nodoc
abstract mixin class _$GetProductModelCopyWith<$Res> implements $GetProductModelCopyWith<$Res> {
  factory _$GetProductModelCopyWith(_GetProductModel value, $Res Function(_GetProductModel) _then) = __$GetProductModelCopyWithImpl;
@override @useResult
$Res call({
 int? id, String? title, double? price, String? description, String? category, String? image, RatingModel? rating
});
...
/// @nodoc
class __$GetProductModelCopyWithImpl<$Res>
    implements _$GetProductModelCopyWith<$Res> {
  __$GetProductModelCopyWithImpl(this._self, this._then);

  final _GetProductModel _self;
  final $Res Function(_GetProductModel) _then;
...
class _RatingModel implements RatingModel {
  const _RatingModel({this.rate, this.count});
